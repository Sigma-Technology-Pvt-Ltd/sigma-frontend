...
export const MetaContextProvider = (props) => {
  ...
  const loadData = async () => {
    ...
    if (slug) {
      await axios
        .get(`${process.env.REACT_APP_SECRET_KEY}/api/pages/${slug}`, {
          headers: {
      ...
      <>
        {meta.slug === slug ? (
          <Helmet>
            ...
            {meta.seo_keyword && (
              <meta name="keyword" content={meta.seo_keyword} />
            )}
            <link rel="canonical" href={window.location.href} />
            <meta property="og:locale" content="en_US" />
            <meta property="og:type" content="website" />
            <meta property="og:title" content={meta.seo_title || meta.title} />
            <meta property="og:url" content={window.location.href} />
            {meta.seo_description && (
              <meta property="og:description" content={meta.seo_description} />
            )}
            <meta property="og:site_name" content="Sigma Technologies" />
