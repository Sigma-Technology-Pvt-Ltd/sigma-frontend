      ...
      >
        ...
        <HeaderContent>
            ...
            <NavigationMenu className="list-inline mb-0">
              {navLink?.map((item, index) => (
                <MenuItem
                  ...
                  index={index}
                  about={item.title === "About" ? true : false}
                  loading={loading}
                />
              ))}
            </NavigationMenu>
          ...
          <NavigationAdditional>
            <NavigationWrapper>
              <NavigationIcon>
                <img src={"/images/png/logo/headphones.png"} />
              </NavigationIcon>
              <NavigationInfo>
                <span>Have Any Questions?</span>
                <a href="tel:+9779801113668" className="mb-0">
                  (+977) 9801113668
                </a>
              </NavigationInfo>
            </NavigationWrapper>
        ...
        <MobileMenu categories={navLink} categoryList={categories} />
      </NavigationContainer>
    </>
  );
};
